...
Debido a que la desviación estandar y el promedio están en la misma escala, al dividir ambos estadísticos y multiplicar por 100, se obtiene el nivel de dispersión en una escala estándar. Este indicador funciona para comparar el grado de dispersión entre distintas distribuciones de datos.
